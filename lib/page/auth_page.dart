import 'package:google_signin_example/page/firestore_islemleri.dart';
import 'package:google_signin_example/provider/email_sign_in.dart';
      ...
      if (isSuccess) {
       // Navigator.of(context).pop();
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ss2()));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => FirestoreIslemleri()));
        },
        child: Text("login den sonra"),
      )),
    );
  }
}
